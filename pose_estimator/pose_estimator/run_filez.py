...
#                         angular_vel = 0.1
#                         if self.depth_at_person >desired_distance and self.person_x == 0.5:
#                             # msg.linear.x = linear_vel * distance_error
#                             # msg.angular.z = 0.0 # Straight
#                             print('dds')
#                         elif self.depth_at_person >desired_distance and self.person_x < 0.4:
#                             msg.angular.z = angular_vel  # Turn right
#                             self.publisher_.publish(msg)
#                             print('ddl')
#                         elif self.depth_at_person >desired_distance and self.person_x > 0.6:
